...
def test_tekme(link):
    ...
    for tekma in tabela_tekm:
        ...
        goli_d = re.findall(r'<td class="fhgoal".+<td class="fagoal"',tekma,re.DOTALL)
        # <td class="fhgoal"
        # <td class="fagoal"
            
        urejena_tabela_tekm.append((goli_d,datum,domaci,domaci_uradno,rez,gosti,gosti_uradno,stadion))
    
    return urejena_tabela_tekm

a = test_tekme("https://en.wikipedia.org/wiki/2019%E2%80%9320_UEFA_Champions_League_group_stage")
# b = test_tekme('https://en.wikipedia.org/wiki/2016%E2%80%9317_UEFA_Champions_League_knockout_phase')
